...
@Repository
public class DynamoDBTemplateAdapter extends TemplateAdapterOperations<User, String, UserEntity /*adapter model*/> implements IUserDynamoTraceabilityGateway {
    ...
    public DynamoDBTemplateAdapter(DynamoDbEnhancedAsyncClient connectionFactory, ObjectMapper mapper) {
         ...
         */
        super(connectionFactory, mapper, userEntity -> mapper.map(userEntity, User.class /*domain model*/), "users");
    }
